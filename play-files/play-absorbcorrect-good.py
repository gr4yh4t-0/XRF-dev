...
def XRF_line(Element,Beam_Energy):                                                  
    ...
    F = xl.LineEnergy(Z,xl.KA1_LINE)                                            #initialize F as Ka1 energy for element of choice
    if xl.EdgeEnergy(Z,xl.K_SHELL) > Beam_Energy:                               #check if 
...
dt = 10 * (1*10**-3) * (1*10**-4)                                   #calculate convert 10nm to cm: 10nm * (1um/1000nm) * (1cm/10000um)
