...
scanlist = {'439' '550'};     % these are sector 2; sector 26 scans must be a 3 digit number
datelist = {'Dec 17' 'Dec 17'};
%Corresponding names of samples for each scan
samplename={'TS58A' 'NBL3-2'};
electtype= {'XBIC' 'XBIC'};
...
[a, b, c] = CdTe_Absorb_medCu(sample, date);              %-->
WORK.ele_IIO = [a b c];                                 
