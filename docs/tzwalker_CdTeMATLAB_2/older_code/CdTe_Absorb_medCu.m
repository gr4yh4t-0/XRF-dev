function [fCd, fTe, fCu] = CdTe_Absorb_medCu(sample, rundate)
...
x_Mo = 5.0E-5;              %cm
x_ZnTe = 3.75E-5;           %cm   
x_Cu = 5E-8;              %cm          MUST CHANGE FOR EACH CdTe SAMPLE
x_CdTe = 5.0E-4;              %cm
x_CdS = 8E-6;            %cm
...
cd3 = exp(-mu_Cu_CdL*p_Cu*x_Cu/rad_det); 
...
te3 = exp(-mu_Cu_TeL*p_Cu*x_Cu/rad_det); 
