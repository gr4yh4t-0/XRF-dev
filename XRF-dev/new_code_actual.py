...
scan4 = {"sector": 2, 'Scan #': 550, 'Name': 'NBL3-2', 'width': 15, 'height': 15, 'x_points': 150, 'y_points': 150, 'beam_energy': 8.99, 'stanford': 5000, 'lockin': 100, 'PIN beam_on': 105400, 'PIN beam_off': 510, 'PIN stanford': 500, "absorber_Eg": 1.45, 'E_abs': 5907, "EOI": ['Sn_L', 'S', 'Cd_L', 'Te_L', 'Cu', 'Cl', 'Mo_L']}

           
scan_list = [scan1, scan2, scan3, scan4]

imported_scans = shrinkASCII(scan_list)
# =============================================================================
# generate_scalar_factor(scan_list)
# collect_XBIC(XCE_corrected_dfs)
# interpolate_diode_calibration(scan_list)
# get_flux(scan_list)
# calc_XCE(XCE_corrected_dfs, scan_list)
# 
# mapConvertAxes(XCE_corrected_dfs, scan_list)
# list_of_shaped_XCE_dfs = mapShape(XCE_corrected_dfs)
